...
- [x] **EDUC-01**: User can view a guide page explaining the GSD workflow (discuss → plan → execute → verify) in simple visual terms
- [x] **EDUC-02**: Guide page is accessible regardless of GSD install state (always available as a view/tab)
